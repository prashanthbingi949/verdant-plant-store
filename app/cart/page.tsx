  ...
  return (
    <main className="vd-cart-page">
      <style>{`
        ...
        .vd-cart-grid{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(340px,.7fr);gap:34px;margin-top:46px}.vd-cart-items{display:grid;gap:12px}
        ...
        .vd-cart-summary{position:sticky;top:98px;align-self:start;border-radius:30px;background:var(--forest);color:var(--cream);padding:26px;box-shadow:0 26px 64px rgba(32,45,32,.17)}
        ...
        @media(max-width:900px){.vd-cart-grid{grid-template-columns:1fr}.vd-cart-summary{position:static}.vd-cart-item{grid-template-columns:116px minmax(0,1fr)}}

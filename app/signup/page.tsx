        ...
        <section className="mx-auto grid w-full max-w-5xl flex-1 items-center gap-10 py-14 lg:grid-cols-[1fr_.82fr] lg:gap-16">
          ...
          <div className="rounded-[32px] border-2 border-[#202d20]/15 bg-[#fafbf4] p-6 shadow-[0_18px_60px_rgba(32,45,32,0.12)] sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="mt-2 flex h-12 w-full items-center justify-center rounded-full bg-[#202d20] !text-[#f4f5e9] text-sm font-black transition hover:bg-[#101510] disabled:cursor-not-allowed disabled:opacity-60">{loading ? "Creating account…" : "Create account"}</button>

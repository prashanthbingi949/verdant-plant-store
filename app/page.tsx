...
export default function Home() {
  ...
  return <main className="verdant-site">
    ...
    {visible("marquee") && <section className="marquee"><div>{content("marquee").text || "PLANT MORE JOY · PLANT MORE JOY · PLANT MORE JOY ·"}</div></section>}

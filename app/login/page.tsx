      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl flex-col">
        <header className="flex items-center justify-between border-b border-[#202d20]/20 pb-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link href="/signup" className="rounded-full border-2 border-[#202d20] px-4 py-2 text-sm font-bold text-[#202d20] transition hover:bg-[#202d20] hover:text-[#f4f5e9]">Sign up</Link>
        ...
        <section className="mx-auto grid w-full max-w-5xl flex-1 items-center gap-10 py-14 lg:grid-cols-[1fr_.82fr] lg:gap-16">
          <div>
            <p className="text-[10px] font-black tracking-[0.22em] text-[#315233]">WELCOME BACK</p>
            <h1 className="mt-4 max-w-2xl text-5xl font-black leading-[0.9] tracking-[-0.06em] sm:text-7xl">
              Keep growing with <span className="font-serif font-normal italic text-[#426a3f]">Verdant.</span>
            </h1>
            <p className="mt-6 max-w-lg text-sm font-medium leading-7 text-[#31422f] sm:text-base">
              Log in to keep your account details handy and make your next plant order easier.
            </p>
            <div className="mt-7 text-sm font-semibold text-[#263926]">
              New to Verdant? <Link href="/signup" className="underline decoration-2 underline-offset-4 hover:text-[#101510]">Create an account</Link>
            </div>
          </div>
          ...
          <div className="rounded-[32px] border-2 border-[#202d20]/15 bg-[#fafbf4] p-6 shadow-[0_18px_60px_rgba(32,45,32,0.12)] sm:p-8">
            {submitted ? (
              <div className="py-10 text-center">
                ...
                <h2 className="mt-5 text-2xl font-black">Welcome back.</h2>
                <p className="mt-2 text-sm font-medium leading-6 text-[#4c5e4a]">
                  The login form is ready for the customer-authentication connection.
                </p>
                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
                  ...
                  <Link href="/" className="inline-flex items-center justify-center rounded-full border-2 border-[#202d20] px-5 py-3 text-sm font-bold text-[#202d20]">Back home</Link>
                </div>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input id="password" name="password" type="password" required autoComplete="current-password" className="mt-2 h-12 w-full rounded-2xl border-2 border-[#202d20]/15 bg-[#eef2df] px-4 font-medium text-[#101510] outline-none placeholder:text-[#6a7765] focus:border-[#202d20]" />
                </div>
                <div className="flex justify-end">
                  <button type="button" className="text-xs font-bold text-[#426a3f] hover:text-[#202d20]">Forgot password?</button>
                </div>
                <button type="submit" className="flex h-12 w-full items-center justify-center rounded-full bg-[#202d20] text-sm font-black text-[#f4f5e9] transition hover:bg-[#101510]">
                  Log in
                </button>

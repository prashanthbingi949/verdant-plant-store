...
export default function VerdantSpotlightHero() {
  ...
  const accountClass = scrolled ? "rounded-full border-2 border-[#202d20] px-4 py-2 text-sm font-bold text-[#202d20] hover:bg-[#202d20] hover:text-[#f4f5e9] transition-colors" : "rounded-full border border-white/35 bg-white/10 px-4 py-2 text-sm font-bold text-white backdrop-blur-md hover:bg-white hover:text-[#101510] transition-colors";

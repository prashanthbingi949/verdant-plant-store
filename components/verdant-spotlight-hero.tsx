...
export default function VerdantSpotlightHero() {
  ...
  return <section ref={heroRef} className="verdant-spotlight relative w-full overflow-hidden bg-black h-screen" style={{ height: "100dvh", minHeight: "560px", fontFamily: "Inter, Arial, sans-serif" }}>
    ...
    <div className="absolute bottom-10 sm:bottom-20 left-5 right-5 sm:left-auto sm:right-10 md:right-14 z-50 max-w-full sm:max-w-[310px] flex flex-col items-start gap-3 sm:gap-4 hero-anim hero-fade" style={{ animationDelay: "0.75s" }}>
      <p className="max-w-[280px] text-xs sm:text-[13px] leading-relaxed text-white/78 italic" style={{ fontFamily: "'Brush Script MT', 'Segoe Script', 'Snell Roundhand', cursive" }}>{hero.description}</p>
